...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($driver === 'sqlite') {
            ...
            DB::statement(
                "UPDATE sqlite_master SET sql = REPLACE(sql, \"'image', 'document'\", \"'image', 'document', 'audio'\") WHERE name = 'messages' AND type = 'table'"
            );
    ...
    public function down(): void
    {
        ...
        if ($driver !== 'sqlite') {
            DB::statement("ALTER TABLE messages MODIFY attachment_type ENUM('image', 'document') NULL");
        }
    }
};
