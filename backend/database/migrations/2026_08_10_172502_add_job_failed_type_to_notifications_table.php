...
{
    private const OLD_TYPES = "'new_message', 'campaign_completed', 'campaign_failed', 'automation_triggered', 'whatsapp_call_missed', 'whatsapp_call_completed', 'whatsapp_call_ringing', 'voice_call_completed', 'voice_call_missed', 'voice_call_ringing', 'template_approved', 'template_rejected', 'chatbot_handoff'";

    private const NEW_TYPES = "'new_message', 'campaign_completed', 'campaign_failed', 'automation_triggered', 'whatsapp_call_missed', 'whatsapp_call_completed', 'whatsapp_call_ringing', 'voice_call_completed', 'voice_call_missed', 'voice_call_ringing', 'template_approved', 'template_rejected', 'chatbot_handoff', 'job_failed'";
